...
<?php foreach ($sec as $key => $value): ?>
    <div class="main_title_2">
                <span><em></em></span>
                <h1 style="color: <?php echo $color; ?>"><i class="<?php echo $value->nc_icono; ?>"></i>  <?php echo $value->nc_noticia; ?></h1>
            </div>
<?php endforeach ?>
...
<script>
 ...
 function noticia(valorBuscar, pagina, cantidad) {
     $.ajax({
         url: "<?php echo base_url(); ?>Controller_periodico/all_notice/<?php echo $id; ?>",
         type: "POST",
         data: {
             buscar: valorBuscar,
             nropagina: pagina,
