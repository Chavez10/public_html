<div class="container-fluid" style="background: #fff;box-shadow: 8px 8px 4px 0px rgba(0,0,0,.5);border: 1px solid #C8C4C4;">
    ...
    <h2 style="text-align: center;padding: 12px;font-weight: bold;">Conocenos</h2>
    ...
    <div class="table table-responsive">
        <table id="tbconocenos" class="table" width="100%">
            <thead>
                <tr>
            ...
            <div class="modal-content">
                ...
                <form class="" id="developer_cu_form">
                    <div class="modal-body">
                        ...
                        <div class="form-group pmd-textfield pmd-text-field-floating-label">
                            <label for="Developer Name" class="control-label">Historia</label>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/main_js/web_conocenos.js"></script>
