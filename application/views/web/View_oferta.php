<div class="container-fluid" style="background: #fff;box-shadow: 8px 8px 4px 0px rgba(0,0,0,.5);border: 1px solid #C8C4C4;">
    ...
    <h2 style="text-align: center;padding: 12px;font-weight: bold;">Cursos</h2>
    ...
    <div class="table table-responsive">
        <table id="tbcur" class="table" width="100%">
            <thead>
                <tr>
                    <th class="info" width="5%"><center>Estado</center></th>
                    <th class="info" width="10%"><center>Curso</center></th>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group pmd-textfield pmd-text-field-floating-label">
                            ...
                            <select name="categoria" id="categoria">
                                <option value="">--Selecciona una opción--</option>
                                    <?php foreach ($buscas as $key => $value): ?>
                                        <option value="<?php echo $value->id_busc; ?>"><?php echo $value->formacion; ?></option>
                                    <?php endforeach ?>                               
                            </select>
                        </div>
                        <div class="form-group pmd-textfield pmd-text-field-floating-label">
                            <label for="Developer Name" class="control-label">Curso</label>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/main_js/web_oferta.js"></script>
