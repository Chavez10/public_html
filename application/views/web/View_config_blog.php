<div class="container-fluid" style="background: #fff;box-shadow: 8px 8px 4px 0px rgba(0,0,0,.5);border: 1px solid #C8C4C4;">
    ...
    <h2 style="text-align: center;padding: 12px;font-weight: bold;">Publicaciones</h2>
    <button type="button" class="btn btn-primary" id="create_acc_btn" data-toggle="modal" data-target="#create_form_modal">Agregar publicación</button>
    ...
    <div class="table table-responsive">
        <table id="tbblog" class="table" width="100%">
            <thead>
                <tr>
            ...
            <th class="info" width="15%"><center>Categoria</center></th>
            ...
            <div class="modal-content">
                ...
                <form class="" id="developer_cu_form">
                    <div class="modal-body">
                        ...
                        <div class="form-group pmd-textfield pmd-text-field-floating-label">
                            <label for="Developer Name" class="control-label">Categoria</label>
                        ...
                        <label for="Developer Skill" class="control-label">Redactor</label>
                        <select name="redactor" id="redactor"  class="form-control se" style="width: 100%;">
                            <option selected="selected">Buscar redactor</option>
                            <?php foreach ($redactor as $key => $value): ?>
                                <option value="<?php echo $value->id_redactor ?>"><?php echo $value->nombres; ?> <?php echo $value->apellidos; ?></option>
                            <?php endforeach ?>
