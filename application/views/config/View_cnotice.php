<div class="container-fluid" style="background: #fff;box-shadow: 8px 8px 4px 0px rgba(0,0,0,.5);border: 1px solid #C8C4C4;">
    <h3 align="center">Gestion de Categorias</h3>
    <button type="button" class="btn btn-primary" id="create_acc_btn" data-toggle="modal" data-target="#create_form_modal">Agregar categoria<i class=""></i></button>
    <br><br>
    <div class="col-md-4">
        <p>
    ...
    <table id="tbcnot" class="table table-responsive" width="100%">
        <thead>
            <tr>
                <th class="info"  width="15%">#</th>
                <th class="info" width="20%">Categoria</th>
                <th class="info" width="20%">Icono</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header pmd-modal-bordered">
                <h2 class="pmd-cart-title-text" id="form-title">Crear Categoria</h2>
            </div>
            <form class="" id="developer_cu_form">
                <div class="modal-body">
                    <div class="form-group pmd-textfield pmd-text-field-floating-label">
                        ...
                        <input type="text" class="form-control" name="nc_noticia" id="nc_noticia">
                    </div>
                    <div class="form-group pmd-textfield pmd-text-field-floating-label">
                        <label for="Developer Skill" class="control-label">Icono</label>
                        <select name="nc_icono" id="nc_icono"  class="form-control se" style="width: 100%;">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/main_js/web_cat_noticia.js"></script>
