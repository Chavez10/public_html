<div class="container-fluid" style="background: #fff;box-shadow: 8px 8px 4px 0px rgba(0,0,0,.5);border: 1px solid #C8C4C4;">
    ...
    <h2 style="text-align: center;padding: 12px;font-weight: bold;">Cabecera Carrucel</h2>
    <button type="button" class="btn btn-primary" id="create_acc_btn" data-toggle="modal" data-target="#create_form_modal">Agregar Carrousel</button>
    <br><br>
    <div class="col-md-4">
        <p>
    ...
    <div class="col-md-4 col-md-offset-4" >
        <input type="text" class="form-control" name="busqueda" placeholder="Buscar por titulo" />
        <br>
    </div>
    <div class="table table-responsive">
        <table id="tbcarr" class="table" width="100%">
            <thead>
                <tr>
            ...
            <div class="modal-content">
                ...
                <form class="" id="developer_cu_form">
                    <div class="modal-body">
                        ...
                        <div class="form-group pmd-textfield pmd-text-field-floating-label">
                            <label for="Developer Name" class="control-label">Url</label>
