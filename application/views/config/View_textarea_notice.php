<form id="tarea" role="form" action="Controller_notice/rellena_textarea/<?php echo $id; ?>" method="post">
	<?php foreach ($textarea as $key => $value): ?>
                        ...
                        <div class="form-group pmd-textfield pmd-text-field-floating-label">
                            ...
                            <textarea name="Nota" id="Nota" cols="100" rows="100" ><?php echo $value->Nota; ?></textarea>
                        </div>
<?php endforeach ?>

<div align="center">
    <button type="submit" class="btn btn-info col-md-2">subir</button>
    <a class="btn btn-danger col-md-2" href="<?php echo base_url(); ?>Controller_notice/vista_oferta">Cancelar</a>
